...
<body>
                        ...
                        <div class=" col-md-10 col-lg-6 col-xl-12">
                            <div class="d-flex flex-row align-items-center mb-4">
                                ...
                                <div class=" flex-fill mb-0  ms-3 me-3  ">
                                    <input type="text" id="name" class="form-control shadow  " placeholder="รหัส"
                                        name="name" required style="border-radius: 15px;" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class=" col-md-10 col-lg-6 col-xl-12">
                            <div class="d-flex flex-row align-items-center mb-4">
                                ...
                                <div class=" flex-fill mb-0 ms-3 me-3">
                                    <textarea id="description" class="form-control shadow" placeholder="คำอธิบายโครงการ"
                                        name="description" required style="border-radius: 15px;"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class=" col-md-10 col-lg-6 col-xl-12">
                            <div class="d-flex flex-row align-items-center mb-4">
                                ...
                                <div class=" flex-fill mb-0 ms-3 me-3">
                                    <input type="text" id="form3Example1c" class="form-control shadow  "
                                        placeholder="ชื่อโครงการ" name="project_name" id="project_name" required
                                ...
                                <div class=" flex-fill mb-0 ms-2 me-3 mt-1">
                                    <ul class="ks-cboxtags">
                                        <li><input type="checkbox" id="checkboxOne" value="Rainbow Dash"><label
                                                for="checkboxOne">KPI ยุทธศาสตร์</label></li>
                                        <li><input type="checkbox" id="checkboxTwo" value="Cotton Candy" checked><label
                                                for="checkboxTwo">KPI มหาวิทยาลัย</label></li>
                                        <li><input type="checkbox" id="checkboxThree" value="Rarity" checked><label
                                                for="checkboxThree">EdPEx</label></li>
                                        <li><input type="checkbox" id="checkboxFour" value="Moondancer"><label
                                                for="checkboxFour">OKR</label></li>
                                        <li><input type="checkbox" id="checkboxFive" value="Surprise"><label
                                                for="checkboxFive">Risk</label></li>
                                        <li><input type="checkbox" id="checkboxSix" value="Twilight Sparkle"
                                                checked><label for="checkboxSix">CHE-QA/AUN-QA
                                            </label></li>
                                        <li><input type="checkbox" id="checkboxSeven" value="Fluttershy"><label
                                                for="checkboxSeven">ข้อมูลพื่นฐาน</label></li>
                                    </ul>
    ...
    <script src="../../controllers/indicator/detailIndicatorController.js"></script>
